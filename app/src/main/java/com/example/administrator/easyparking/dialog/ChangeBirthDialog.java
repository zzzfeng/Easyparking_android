...
//        }
        ...
        arry_months.add("" + currentMonth);
        int nextMonth = currentMonth + 1;
        if (nextMonth > 12) {
            nextMonth = 1;
            arry_years.add("" + (getYear() + 1));
        }
        arry_months.add("" + nextMonth);
    }

    public void initDays(int days) {
        arry_days.clear();
        if (Integer.parseInt(selectMonth) == getMonth()) {
    ...
    public int getYear() {
        ...
        Log.d("TAG", "this year is " + c.get(Calendar.YEAR));
